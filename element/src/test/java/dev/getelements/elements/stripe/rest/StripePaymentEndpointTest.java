...
class StripePaymentEndpointTest {
    ...
    void updateCustomer_callsServiceAndReturns204() {
        ...
        final var response = endpoint.updateCustomer("cus_test", request);
    ...
    void cancelSubscription_delegatesToServiceAndReturnsResult() {
        ...
        final var result = endpoint.cancelSubscription("sub_test");
    ...
    void listProducts_delegatesToServiceAndReturnsResult() {
        ...
        assertSame(expected, endpoint.listProducts(true, 100));
    }
    ...
    void listPrices_delegatesToServiceAndReturnsResult() {
        ...
        assertSame(expected, endpoint.listPrices("prod_001", true, 100));
    }
    ...
    void retrievePrice_delegatesToServiceAndReturnsResult() {
        ...
        assertSame(expected, endpoint.retrievePrice("price_001"));
    }
    ...
    void findCustomerByMetadata_found_returnsCustomerId() {
        ...
        assertEquals("cus_found", endpoint.findCustomerByMetadata("orgId", "org_001").customerId());
    }
    ...
    void findCustomerByMetadata_notFound_throwsNotFoundException() {
        ...
        assertThrows(NotFoundException.class,
                () -> endpoint.findCustomerByMetadata("orgId", "org_missing"));
    }
    ...
    void createSubscription_delegatesToServiceAndReturnsResult() {
        ...
        assertSame(expected, endpoint.createSubscription("cus_test", request));
    ...
    void listInvoices_delegatesToServiceAndReturnsResult() {
        ...
        assertSame(expected, endpoint.listInvoices("cus_test", 10, null));
    ...
    void createCheckoutSession_delegatesToServiceAndReturnsResult() {
        ...
        assertSame(expected, endpoint.createCheckoutSession(request));
    }
